...
# # 🔧 Monkey-patch to catch all dataset loading calls globally
# original_load_dataset = datasets.load_dataset

# def debug_load_dataset(path, **kwargs):
#     import traceback
#     print("🚨 INTERCEPTED: datasets.load_dataset CALLED!")
#     print(f"📂 path = {path}")
#     print(f"📄 kwargs = {kwargs}")
#     print("📌 STACK TRACE:")
#     traceback.print_stack(limit=5)
#     print("=====================================")
#     return original_load_dataset(path, **kwargs)

# datasets.load_dataset = debug_load_dataset


# 🔍 Your wrapped loader (still uses the patched global function)
def load_hf_dataset(path, **kwargs):
    # print("========== Loading dataset via load_hf_dataset ==========")
    # print(f"📂 path = {path}")
    # print(f"📄 kwargs = {kwargs}")
    # print("📌 STACK TRACE:")
    # import traceback
...
def preprocess_chat_instance(
    ...
    # apply_chat_template = template_config.get("apply_chat_template", None) if template_config else None
    ...
    if template_config["apply_chat_template"]:
        ...
        #     truncation=True,
        # )["input_ids"]
        # Use plain prompt + response without any template tags
        final_prompt, final_response = prompt_msgs[-1], response_msgs[-1]
